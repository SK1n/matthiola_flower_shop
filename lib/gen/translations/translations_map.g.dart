...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'cart.priceChanged': return ({required Object value}) => 'Pretul produsului s-a schimba, pret nou ${value}';
			case 'cart.notEnoughStock': return ({required Object value}) => 'Nu este suficent stock, maxim ${value}';
			...
			case 'sign_in.title': return 'Bun venit înapoi';
			case 'sign_in.emailLabel': return 'Introduceți adresa de email';
			case 'sign_in.emailHint': return 'De exemplu, numeletau@gmail.com';
			case 'sign_in.emailIsValid': return 'Emailul este valid';
			case 'sign_in.emailFormat': return 'Format email';
			case 'sign_in.emailPrefix': return 'Email';
			case 'sign_in.passwordLabel': return 'Introduceți parola';
			case 'sign_in.passwordShort': return 'Cel puțin 8 caractere.';
			case 'sign_in.passwordPrefix': return 'Parolă';
			case 'sign_in.passwordMissingLetter': return 'Cel puțin 1 literă.';
			case 'sign_in.passwordMissingDigit': return 'Cel puțin 1 cifră.';
			case 'sign_in.noAccount': return 'Nu aveți încă un cont?';
			case 'sign_in.register': return 'Înregistrați-vă';
			case 'sign_in.signIn': return 'Autentificare';
			case 'sign_in.signInWithGoogle': return 'Autentificare cu Google';
			...
			case 'sign_up.emailIsValid': return 'Emailul este valid';
			case 'sign_up.emailFormat': return 'Format email';
			case 'sign_up.passwordLabel': return 'Introduceți parola';
			case 'sign_up.passwordShort': return 'Cel puțin 8 caractere.';
			case 'sign_up.passwordMissingLetter': return 'Cel puțin 1 literă.';
			case 'sign_up.passwordMissingDigit': return 'Cel puțin 1 cifră.';
			case 'sign_up.rePasswordLabel': return 'Introduceți din nou parola';
			case 'sign_up.passwordMismatch': return 'Parolele nu se potrivesc';
			case 'sign_up.accountCreated': return 'Cont creat!';
			case 'sign_up.usernameLabel': return 'Numele florăriei';
			case 'sign_up.required': return 'Acest câmp este obligatoriu';
			...
			case 'sign_up.phoneFormat': return 'Format greșit al numărului de telefon\nAcceptăm următoarele:\n+40213-564-864\n+40213.564.864\n+40213 564 864\n0213-564-864\n0712456789';
			default: return null;
		}
	}
}
...
extension on _TranslationsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'sign_in.emailIsValid': return 'Email is valid';
			case 'sign_in.emailFormat': return 'Email format';
			case 'sign_in.emailPrefix': return 'Email';
			case 'sign_in.passwordLabel': return 'Enter your password';
			case 'sign_in.passwordShort': return 'At least 8 characters.';
			case 'sign_in.passwordPrefix': return 'Password';
			case 'sign_in.passwordMissingLetter': return 'At least 1 letter.';
			case 'sign_in.passwordMissingDigit': return 'At least 1 number.';
			...
			case 'sign_in.signInWithGoogle': return 'Sign in with Google';
			case 'sign_up.title': return 'Create account';
			case 'sign_up.emailLabel': return 'Enter your email address';
			case 'sign_up.emailHint': return 'E.g. yourname@gmail.com';
			case 'sign_up.emailIsValid': return 'Email is valid';
			case 'sign_up.emailFormat': return 'Email format';
			case 'sign_up.passwordLabel': return 'Enter your password';
			case 'sign_up.passwordShort': return 'At least 8 characters.';
			case 'sign_up.passwordMissingLetter': return 'At least 1 letter.';
			case 'sign_up.passwordMissingDigit': return 'At least 1 number.';
			case 'sign_up.rePasswordLabel': return 'Enter your password again';
			case 'sign_up.passwordMismatch': return 'The passwords match';
			case 'sign_up.accountCreated': return 'Account created!';
			case 'sign_up.usernameLabel': return 'Flower shop name';
			case 'sign_up.required': return 'This field is required!';
			...
			case 'sign_up.phoneFormat': return 'Incorrect phone number format\nWe accept the following:\n+40213-564-864\n+40213.564.864\n+40213 564 864\n0213-564-864\n0712456789';
			default: return null;
		}
	}
}
